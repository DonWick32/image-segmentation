...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _run_single_frame_inference(
        ...
        # print("stage_id", frame_idx)
        # print("init_cond_frames", is_init_cond_frame)
        # print("current_vision_feats", [i.shape for i in current_vision_feats])
        # print("feat_sizes", feat_sizes)
        # print("current_vision_pos_embeds", [i.shape for i in current_vision_pos_embeds])
        # print("backbone_out['point_inputs_per_frame']", point_inputs)
        # print("backbone_out['mask_inputs_per_frame']", mask_inputs)
        # print("outputdict",[(k, v.keys()) for k, v in output_dict['cond_frame_outputs'].items()])
        # if 0 in output_dict['cond_frame_outputs']:
        #     print([(k, [(i.shape) for i in v]) for k, v in output_dict['cond_frame_outputs'][0].items()])
        # print("non cond outputdict",[(k, v.keys()) for k, v in output_dict['non_cond_frame_outputs'].items()])
